...
{-
      Los polinomios de Bernoulli son una serie de polinomios Bn(x) 
      con grado igual a n, sobre el cuerpo de los racionales con aplicaciones 
      en teoría de números y combinatoria, con especial aplicación a teoría 
      analítica de números.
      El propósito aquí es utilizarlos para comprender la fórmula de sumación de 
      Euler-Mclaurin y obtener formas eficientes de calcular la función zeta 
      de Riemann en el plano complejo.
